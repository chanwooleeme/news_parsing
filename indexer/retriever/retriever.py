...
from indexer.embedder import NewsEmbedder  # 임베더 불러오기
from qdrant_client.http.models import Filter, FieldCondition, MatchText

class NewsRetriever:
    def __init__(self, collection_name: str = "news-articles"):
    ...
    def search(self, query: str, top_k: int = 5, filters: Optional[Dict[str, str]] = None) -> List[Dict]:
        ...
        results = response.points  # <- 이렇게 접근해야 함
